...
@Autonomous(name="OnePlusOneRight", group="Blue")
public class OnePlusOneRight extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        traj7 = drive.trajectoryBuilder(traj6.end(), false)
                .lineToLinearHeading(new Pose2d(-13.1, 9.5, Math.toRadians(-180)))
                .build();
        ...
        traj9 = drive.trajectoryBuilder(traj8.end(), false)
                .lineToLinearHeading(new Pose2d(-53, 9.5, Math.toRadians(-180)))
                .addDisplacementMarker(() -> {
                    claw.setPosition(0);
        ...
        traj12 = drive.trajectoryBuilder(traj11.end(), false)
                ...
                .lineToLinearHeading(new Pose2d(-35, 9.5, Math.toRadians(-180)), SampleMecanumDrive.getVelocityConstraint(35, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
